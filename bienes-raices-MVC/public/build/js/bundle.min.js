function darkMode(){const e=window.matchMedia("(prefers-color-scheme: dark)"),n=document.querySelector(".btn-dark-mode");e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode"),e.addEventListener("change",(function(){e.matches?document.body.classList.add("dark-mode"):document.body.classList.remove("dark-mode")})),n.addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}))}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",responsiveNav);document.querySelectorAll('input[name="contact[contact]"]').forEach(e=>e.addEventListener("click",showContactMethods))}function responsiveNav(){document.querySelector(".nav").classList.toggle("show-nav")}function showContactMethods(){console.log("seleccionando")}
