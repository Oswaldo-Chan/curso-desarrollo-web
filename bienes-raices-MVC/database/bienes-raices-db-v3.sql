...
CREATE TABLE `blog` (
  ...
  CONSTRAINT `blog_ibfk_1` FOREIGN KEY (`autor`) REFERENCES `usuarios` (`id`)
...
INSERT INTO `usuarios` VALUES (2,'Oswaldo','Chan','correo@correo.com','$2y$10$f55Y88uTgMd6wTC/wercuOqzcv5DAj0p739XZuEAuvgSpjxtQjgrC'),(4,'Alex','Tapia','correo2@correo.com','$2y$10$f55Y88uTgMd6wTC/wercuOqzcv5DAj0p739XZuEAuvgSpjxtQjgrC');
...
-- Dump completed on 2023-06-09  4:25:14
