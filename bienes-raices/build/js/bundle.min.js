function darkMode(){document.querySelector(".btn-dark-mode").addEventListener("click",(function(){document.body.classList.toggle("dark-mode")}))}function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",responsiveNav)}function responsiveNav(){document.querySelector(".nav").classList.toggle("show-nav")}
